...
2. Load `.speckit/memory/constitution.md` Section II (enabled mechanics list) — used to cross-check declarations.
...
4. Remind: "Add `[hook_type]` to `.speckit/memory/constitution.md` Section II enabled mechanics list if you want it active for this project."
...
Declared but never used:
  ⚠️  currency     — declared in mechanics.md, no nodes use it
  ⚠️  timer        — declared in mechanics.md, no nodes use it
...
Tier 2 stubs in active use (will produce export warnings):
  ⚠️  knowledge    — used in 3 nodes (NODE-004, NODE-009, NODE-014)
  ⚠️  faction      — used in 1 node (NODE-022)
```
