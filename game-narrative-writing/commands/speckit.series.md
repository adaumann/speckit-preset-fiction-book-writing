...
For each entry in scope, load: `specs/spec.md`, `specs/flowmap.md`, `specs/variables.md`, `specs/endings.md`, `specs/characters/` profiles, `.speckit/memory/constitution.md`. Note missing files as INCOMPLETE.
...
```
⚠️  Action recommended: Run `speckit.series audit` to check cross-entry continuity.
```
