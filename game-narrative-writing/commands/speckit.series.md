...
For each entry in scope, load: `specs/spec.md`, `specs/flowmap.md`, `specs/variables.md`, `specs/endings.md`, `specs/characters/` profiles, `.specify/memory/constitution.md`. Note missing files as INCOMPLETE.
