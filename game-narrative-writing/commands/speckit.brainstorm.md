...
handoffs:
  ...
  - label: Build Flowmap
    agent: speckit.plan
    prompt: Use these brainstorm notes to build the flowmap and act structure
    send: true
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  What do you want to brainstorm?
   ...
   2  flowmap        — Act structure, branches, node graph
...
|---|---|
| `spec` | `.speckit/memory/constitution.md` |
| `flowmap` | `specs/spec.md`, `specs/endings.md` |
| `characters` / `npc` | `specs/spec.md`, `specs/flowmap.md` |
| `branches` | `specs/spec.md`, `specs/variables.md`, `specs/mechanics.md` |
| `endings` | `specs/flowmap.md`, `specs/variables.md` |
| `mechanics` | `.speckit/memory/constitution.md`, `specs/variables.md` |
| `world-building` | `specs/spec.md`, `specs/variables.md` |
| `variables` | `specs/flowmap.md`, `specs/mechanics.md` |
