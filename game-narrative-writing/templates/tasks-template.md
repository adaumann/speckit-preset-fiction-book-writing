...
- Output paths: `specs/[FEATURE_DIR]/outlines/NODE-NNN.md` for outlines, `specs/[FEATURE_DIR]/nodes/NODE-NNN.md` for drafts
...
| ID | Task | Node | Output |
|---|---|---|---|
| T010 | Outline: [NODE_TITLE] — opening, player orientation | NODE-001 | `specs/[FEATURE_DIR]/outlines/NODE-001.md` |
| T011 | Outline: [NODE_TITLE] — first branching decision | NODE-002 | `specs/[FEATURE_DIR]/outlines/NODE-002.md` |
| T012 | Outline: [NODE_TITLE] | NODE-003 | `specs/[FEATURE_DIR]/outlines/NODE-003.md` |
...
| ID | Task | Node | Output |
|---|---|---|---|
| T014 | [P] Draft: [NODE_TITLE] | NODE-001 | `specs/[FEATURE_DIR]/nodes/NODE-001.md` |
| T015 | [P] Draft: [NODE_TITLE] | NODE-002 | `specs/[FEATURE_DIR]/nodes/NODE-002.md` |
| T016 | Draft: [NODE_TITLE] — depends on NODE-002 outcome | NODE-003 | `specs/[FEATURE_DIR]/nodes/NODE-003.md` |
...
| ID | Task | Node | Output |
|---|---|---|---|
| T020 | Outline: [NODE_TITLE] | NODE-[N] | `specs/[FEATURE_DIR]/outlines/NODE-[N].md` |
...
| ID | Task | Node | Output |
|---|---|---|---|
| T022 | [P] Draft: [NODE_TITLE] | NODE-[N] | `specs/[FEATURE_DIR]/nodes/NODE-[N].md` |
...
| ID | Task | Node | Output |
|---|---|---|---|
| T030 | Outline: [CLIMAX_NODE_TITLE] | NODE-[N] | `specs/[FEATURE_DIR]/outlines/NODE-[N].md` |
| T031 | Outline: Ending node — END-A ([ENDING_NAME]) | END-A | `specs/[FEATURE_DIR]/outlines/END-A.md` |
| T032 | Outline: Ending node — END-B ([ENDING_NAME]) | END-B | `specs/[FEATURE_DIR]/outlines/END-B.md` |
...
| ID | Task | Node | Output |
|---|---|---|---|
| T034 | Draft: [CLIMAX_NODE_TITLE] | NODE-[N] | `specs/[FEATURE_DIR]/nodes/NODE-[N].md` |
| T035 | Draft: Ending — END-A ([ENDING_NAME]) | END-A | `specs/[FEATURE_DIR]/nodes/END-A.md` |
| T036 | Draft: Ending — END-B ([ENDING_NAME]) | END-B | `specs/[FEATURE_DIR]/nodes/END-B.md` |
